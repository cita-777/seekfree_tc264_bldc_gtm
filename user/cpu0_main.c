...
// 本程序为英飞凌GTM无刷驱动程序，可以基于本程序学习研究无刷电机的六步换相驱动原理，使用前请务必阅读无刷驱动说明书
// 本程序为英飞凌GTM无刷驱动程序，可以基于本程序学习研究无刷电机的六步换相驱动原理，使用前请务必阅读无刷驱动说明书
// 本程序为英飞凌GTM无刷驱动程序，可以基于本程序学习研究无刷电机的六步换相驱动原理，使用前请务必阅读无刷驱动说明书
...
int core0_main(void)
{
    ...
    while (TRUE)
    {
        ...
        // printf("%f,%f,%f,%f\r\n", (float)motor_control.motor_speed / 10.0f,
        //                           (float)spe_g.speed.duty,
        //                           adc_information.voltage_bus * 1000.0f,
        //                           adc_information.battery_voltage * 100.0f);
